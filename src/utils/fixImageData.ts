...
export function fixImageData(entry: Record<string, unknown>): Record<string, unknown> {
    ...
    const entryWithImages: EntryWithImages = { ...entry, images: entry.images } as EntryWithImages;
    ...
    if (Array.isArray(entryWithImages.images) && entryWithImages.images.every(img => typeof img === "string")) {
